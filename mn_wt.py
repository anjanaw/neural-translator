...
train_data = create_train_instances(_train_features, classes_per_set, samples_per_class, train_size, feature_length)

test_support_set, _test_features = support_set_split(_test_features, samples_per_class)
test_data = create_test_instance(_test_features, test_support_set, classes_per_set, samples_per_class, feature_length)
...
score = model.evaluate([test_data[0], test_data[1]], test_data[2], batch_size=bsize, verbose=1)
print(score)